...
- [ ] 6. コードブロックと補助資料の統合
- [ ] 6.1 (P) 全コードブロックへのPrism.jsシンタックスハイライト適用
...
- [ ] 6.2 (P) トラブルシューティングコマンドとコピーボタン（オプション）の実装
...
- [ ] 7.2 Chrome最新版での動作確認とパフォーマンステスト
